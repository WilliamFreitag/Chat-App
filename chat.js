var socket = io();
var session;
fetch("http://williamf.mynetgear.com:82/getSession").then(data => data.json()).then(data => session = data).then(data => document.getElementById("header").innerHTML = "Hello! You are logged in as: " + data.username);
